...
import ShowAllVehicles from "./RTOhome/RTOoperations/ShowAllVehicles";
import ShowAllOffenceType from "././RTOhome/RTOoperations/ShowAllOffenceType"
...
export default function Dashboard1() {
    ...
    var RolenameFromSessionStorage= sessionStorage.getItem("name")|| "ADMIN";
    return (
        <div>
                ...
                if (RolenameFromSessionStorage.length<1) {
                    ...
                    <Router>
                        <Routes>
                            ...
                            <Route path="/showallvehicle/" element={<ShowAllVehicles />} />
                            <Route path="/showalloffencetype/" element={<ShowAllOffenceType />} />
