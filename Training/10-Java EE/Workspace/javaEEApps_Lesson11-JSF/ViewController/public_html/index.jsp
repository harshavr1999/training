      ...
      <h:form>
        <center>
            ...
            <table>
                ...
                <tr>
                    <td>Password : </td>
                    <td><h:inputSecret value="#{lbRef.password}"
                                       required="true">
                ...
                <tr>
                    <td><h:commandButton value="Login"
                                         action="#{lbRef.navigate}">
                                    <f:actionListener type="oracle.view.OurActionListener"/>
                                </h:commandButton></td>
...
<%-- 
    oracle-jdev-comment:preferred-managed-bean-name:lbRef
--%>