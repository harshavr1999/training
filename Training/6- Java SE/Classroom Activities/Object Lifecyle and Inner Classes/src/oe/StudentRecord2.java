...
public class StudentRecord2 {
	...
	public StudentRecord2(String name){
		this.name = name;
	}

	// Constructor that gets two parameters
	public StudentRecord2(String name, double mGrade){
		this(name);
		mathGrade = mGrade;
	}
 
	// Constructor that gets three parameters
	public StudentRecord2(String name, double mGrade, double eGrade){
		this(name, mGrade);
		englishGrade = eGrade;
	}
 
	// Constructor that gets four parameters
	public StudentRecord2(String name, double mGrade, double eGrade, double sGrade){
		this(name, mGrade, eGrade);
		scienceGrade = sGrade;
	}
	//average is also passed as constructor
	public StudentRecord2(String name, double mGrade, double eGrade, double sGrade, double saverage){
