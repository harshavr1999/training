...
public class DummyClass {
	...
	// Private field. Can be accessed only within the same class.
	private String s1 = "private string";

	// Protected field. Can be accessed only within the same package.
	...
	// Protected method. Can be accessed only within the same package.
