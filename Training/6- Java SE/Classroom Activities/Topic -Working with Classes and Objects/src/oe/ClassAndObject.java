...
public class ClassAndObject {
	public static void main(String[] args) {
		...
		String strInstance1 = new String("I am object instance of a Stringclass");
		System.out.println("value of strIntance1 = " + strInstance1);

		/* 
		String class a special class for which you can create an instance
		of it by assigning a string literal. No other class allows this form
		of object creation.
		*/
		String strInstance2 = "I am object instance of a String class";
		System.out.println("value of strIntance2 = " + strInstance2);
		
		String strInstance3 = "I am another object of a String class";
		System.out.println("value of strIntance3 = " + strInstance3);
