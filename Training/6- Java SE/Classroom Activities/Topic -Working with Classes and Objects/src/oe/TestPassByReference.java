...
public class TestPassByReference {
	public static void main(String[] args) {
		...
		// Create an array of integers and initialize the array with 10, 11, and 12.
		int [] ages = {10, 11, 12};
		
		// Print array values. The array should display 10, 11, 12
		...
		/* 
		Call test and pass references to array. Since the array is a reference type,
		what is being passed is a pointer to actual array.
		*/
		test(ages);
