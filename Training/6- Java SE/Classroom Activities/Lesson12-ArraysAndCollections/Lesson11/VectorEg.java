...
public class VectorEg
{
	public static void main(String[] args) 
	{
		...
		// Java 5 we have capability of Adding int Directly AutoBoxing and UnBoxing
		// AutoBoxing [Language automatically converts primitive to wrapper object]
		// UnBoxing [Language automatically converts wrapper object to primitive]
